...
@pytest.mark.asyncio
async def test_cache_response_operations(model_cache, initialize_test_db):
...
@pytest.mark.asyncio
async def test_error_handling(model_cache, initialize_test_db, monkeypatch):
...
@pytest.mark.asyncio
async def test_cache_expiry(model_cache, initialize_test_db):
